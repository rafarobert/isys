...
class Migration_Create_ci_tables_roles extends CI_Migration
{
    static $tableId = 'id_table_role';
    static $tableName = 'ci_tables_roles';
    static $tableFields = array (
  'id_table_role' => 
  array (
    'tabName' => 'ci_tables_roles',
    'field' => 'id_table_role',
    'type' => 'int',
    'constraint' => '11',
    'unsigned' => false,
  ...
  'ci_tables_roles_id_table_role_uindex' => 
  array (
    'table' => NULL,
    'idLocal' => 'id_table_role',
    'idForeign' => NULL,
  ),
  'ci_tables_roles_ibfk_1' => 
  array (
    'table' => 'ci_users',
    'idLocal' => 'id_user_created',
    'idForeign' => 'id_user',
  ),
  'ci_tables_roles_ibfk_2' => 
  array (
    'table' => 'ci_users',
    'idLocal' => 'id_user_modified',
    'idForeign' => 'id_user',
  ),
  'ci_tables_roles_ibfk_3' => 
  array (
    'table' => 'ci_tables',
    'idLocal' => 'id_table',
    'idForeign' => 'id_table',
  ),
  'ci_tables_roles_ibfk_4' => 
  array (
    'table' => 'ci_roles',
    'idLocal' => 'id_role',
    'idForeign' => 'id_role',
  ...
  'views' => true,
    ...
    {
        //$this->dbforge->drop_table('ci_tables_roles');
    }
}