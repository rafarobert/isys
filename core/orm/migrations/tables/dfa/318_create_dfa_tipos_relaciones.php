...
class Migration_Create_dfa_tipos_relaciones extends CI_Migration
{
    static $tableId = 'id_tipo_relacion';
    static $tableName = 'dfa_tipos_relaciones';
    static $tableFields = array (
  'id_tipo_relacion' => 
  array (
    'tabName' => 'dfa_tipos_relaciones',
  ...
  'dfa_relaciones_id_relacion_uindex' => 
  array (
    'table' => NULL,
    'idLocal' => 'id_tipo_relacion',
    'idForeign' => NULL,
  ),
  'dfa_tipos_relaciones_ibfk_1' => 
  array (
    'table' => 'ci_users',
    'idLocal' => 'id_user_created',
    'idForeign' => 'id_user',
  ),
  'dfa_tipos_relaciones_ibfk_2' => 
  array (
    'table' => 'ci_users',
  ...
  'views' => true,
    ...
    {
        //$this->dbforge->drop_table('dfa_tipos_relaciones');
    }
}