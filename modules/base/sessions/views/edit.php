...
<div class="form-group row">
  ...
  'placeholder' => '',
        ...
        echo form_input($data,set_value("ip_address", $oSession->ip_address),"")
        ?>
    </div>
</div>
<?php echo form_error("ip_address"); ?><div class="form-group row">
  ...
  'placeholder' => '',
        ...
        echo form_input($data,set_value("timestamp", $oSession->timestamp),"")
        ?>
    </div>
</div>
<?php echo form_error("timestamp"); ?><div class="form-group row">
  ...
  'placeholder' => '',
        ...
        echo form_input($data,set_value("data", $oSession->data),"")
        ?>
    </div>
</div>
...
<?php echo form_error("last_activity"); ?><div class="form-group row">
    <label for="fieldId_user" class="col-sm-4 col-form-label col-form-label-md">Id user</label>
    <div class="col-sm-6">
        <?php
        $data = array (
  'name' => 'id_user',
  ...
  'placeholder' => '',
        ...
        echo form_input($data,set_value("id_user", $oSession->id_user),"")
        ?>
    </div>
</div>
<?php echo form_error("id_user"); ?><div class="form-group row">
    <label for="fieldId_hbf_sesion" class="col-sm-4 col-form-label col-form-label-md">Id hbf sesion</label>
    <div class="col-sm-6">
        <?php
        $data = array (
  'name' => 'id_hbf_sesion',
  ...
  'placeholder' => '',
        ...
        echo form_input($data,set_value("id_hbf_sesion", $oSession->id_hbf_sesion),"")
        ?>
    </div>
</div>
