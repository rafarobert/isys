...
<div class="form-group row">
  ...
  'disabled' => true,
        ...
        echo form_disabled($data,$oUsuarios,$oUsuario->invitado_por);
        ?>
    </div>
</div>
...
<div class="form-group row">
    <label for="fieldId_tipo_asociado" class="col-sm-4 col-form-label col-form-label-md">Tipo de asociado</label>
    <div class="col-sm-6">
        <?php
        $data = array (
  ...
  'placeholder' => '',
        ...
        echo form_dropdown($data,$oTiposAsociados,$oUsuario->id_tipo_asociado);
        ?>
    </div>
</div>
...
<div class="form-group row">
    <label for="fieldId_nivel_asociado" class="col-sm-4 col-form-label col-form-label-md">Nivel de asociado</label>
    <div class="col-sm-6">
        <?php
        $data = array (
  ...
  'placeholder' => '',
        ...
        echo form_dropdown($data,$oNivelesAsociados,$oUsuario->id_nivel_asociado);
        ?>
    </div>
</div>
...
<div class="form-group row">
  ...
  'placeholder' => '',
        ...
        echo form_dropdown($data,$oRoles,$oUsuario->id_role);
        ?>
    </div>
</div>
