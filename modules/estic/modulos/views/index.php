<?php // *** estic - index_file - start ***
        ...
        <section>
            ...
            $icon = icon($data_icon);
            echo anchor("estic/modulos/edit", "Agregar Modulos", null, $icon)?>
            ...
            <td><?= btn_edit("estic/modulos/edit/" . $oModulo->id_modulo)?></td>
                        <td><?= btn_delete("estic/modulos/delete/" . $oModulo->id_modulo)?></td>
                    </tr>
                    <?php } ?>
                <?php } else { ?>
                    <tr>
