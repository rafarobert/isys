...
Class Ctrl_UcTableP extends UcModS_Controller {
    ...
    public function __construct()
    {
        ...
        if($this->lcFkObjFieldP == null){
            $lcFkObjFieldP = $this->model_lcFkTableP->get_by('$fFieldsRef');
            $this->lcFkObjFieldP = $this->model_lcFkTableP->setOptions($lcFkObjFieldP);
        }
        //<<<initFieldsForeignTable>>>
        //>>>initFieldImg<<<
    ...
    public function edit($id = NULL){
        ...
        //>>>setObjectForeignTable<<<
        $this->data['oUcFkObjFieldP'] = $this->lcFkObjFieldP;
        //<<<setObjectForeignTable>>>
